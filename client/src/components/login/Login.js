...
// const Login = () => {
//   return (
//     <div className="h-screen w-screen flex justify-center overflow-y-auto overflow-x-hidden bg-white">
//       {/* Light background image for a professional appearance */}
//       <div
//         className="fixed inset-0 bg-cover bg-center bg-no-repeat z-0"
//         style={{ backgroundImage: "url('https://example.com/your-image.jpg')" }} // Replace with your image URL
//       >
//         <div className="absolute inset-0 bg-white opacity-70"></div> {/* Light overlay */}
//       </div>

//       <div className="flex flex-col items-center mt-10 space-y-16 md:space-y-32 z-10 relative">
//         <div className="relative">
//           <h1 className="text-3xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-400">
//             ABC Institute of Technology
//           </h1>
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16">
//           {/* Admin Card with a light gray theme */}
//           <div className="group relative">
//             <div className="absolute -inset-1 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-400 rounded-xl blur-lg opacity-75 group-hover:opacity-100 transition duration-1000"></div>
//             <div className="relative h-80 w-80 md:h-96 md:w-96 flex flex-col justify-center items-center rounded-xl bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 shadow-xl transition-all duration-500 
//                         transform perspective-1000 hover:rotate-y-6 hover:scale-105 group">
//               <div className="relative z-10 space-y-8">
...
//                 <Link
//                   to="/login/adminlogin"
//                   className="flex items-center justify-center bg-white/80 h-12 w-36 text-lg rounded-xl text-gray-800 
...
//           {/* Faculty Card with a light blue theme */}
//           <div className="group relative">
//             <div className="absolute -inset-1 bg-gradient-to-r from-teal-300 via-blue-200 to-teal-400 rounded-xl blur-lg opacity-75 group-hover:opacity-100 transition duration-1000"></div>
//             <div className="relative h-80 w-80 md:h-96 md:w-96 flex flex-col justify-center items-center rounded-xl bg-gradient-to-br from-blue-100 via-teal-200 to-teal-300 shadow-xl transition-all duration-500 
//                         transform perspective-1000 hover:rotate-y-6 hover:scale-105 group">
//               <div className="relative z-10 space-y-8">
//                 <h1 className="text-4xl font-bold text-gray-800">
//                   Faculty
...
//           {/* Student Card with a light pink theme */}
//           <div className="group relative">
//             <div className="absolute -inset-1 bg-gradient-to-r from-pink-200 via-pink-100 to-rose-300 rounded-xl blur-lg opacity-75 group-hover:opacity-100 transition duration-1000"></div>
//             <div className="relative h-80 w-80 md:h-96 md:w-96 flex flex-col justify-center items-center rounded-xl bg-gradient-to-br from-rose-100 via-pink-200 to-pink-300 shadow-xl transition-all duration-500 
//                         transform perspective-1000 hover:rotate-y-6 hover:scale-105 group">
//               <div className="relative z-10 space-y-8">
//                 <h1 className="text-4xl font-bold text-gray-800">
//                   Student
